...
/*Task 1: counterMaker()
  ...
  Counter one is function scope and counter two is block scope.

  2. Which of the two uses a closure? How can you tell?
  counter1 because it uses a function within a function and calls on the outer one. 

  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     The first one is more to create a functional counter while the second one would be used to retrieve a value.
*/
